  ...
  return (
    <div className="bg-white rounded-xl shadow-lg overflow-hidden transition-all duration-300 hover:shadow-2xl hover:-translate-y-2">
      <div className="relative bg-blue-600 text-white p-6">
        ...
        {/* Display Date */}
        <p className="text-sm text-blue-100 mt-2">{date}</p>
      </div>
      <div className="p-6">
        {description && (
          <p className="text-gray-600 mb-4 line-clamp-3">{description}</p>
        ...
        <div className="container max-w-7xl mx-auto px-4 text-center">
          ...
          <div className="flex justify-center space-x-4">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center bg-blue-600 text-white px-8 py-3 rounded-lg hover:bg-blue-700 transition shadow-md hover:shadow-lg"
            >
